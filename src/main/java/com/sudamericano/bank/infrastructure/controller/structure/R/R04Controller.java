...
public class R04Controller {
    ...
    public List<R04ResumeResponse> getAllResume() {
        ...
        for (R04Dto dto : useCase.findAll()) {
            ...
            resume.valorPorVencer1a30 = dto.getValorSaldoVencer1a30d();
            resume.valorPorVencer31a90 = dto.getValorSaldoVencer31a90d();
            resume.valorPorVencer91a180 = dto.getValorSaldoVencer91a180d();
            resume.valorPorVencer181a360 = dto.getValorSaldoVencer181a360d();
            resume.valorPorVencerMas360 = dto.getValorSaldoVencerMasde360d();
            resume.valorNoDevenga1a30 = dto.getValorNoDevInteres1a30d();
            resume.valorNoDevenga31a90 = dto.getValorNoDevInteres31a90d();
            resume.valorNoDevenga91a180 = dto.getValorNoDevInteres91a180d();
            resume.valorNoDevenga181a360 = dto.getValorNoDevInteres181a360d();
            resume.valorNoDevengaMas360 = dto.getValorNoDevInteresMasde360d();
            resume.valorVencido1a30 = dto.getValorVencido1a30d();
            resume.valorVencido31a90 = dto.getValorVencido31a90d();
            resume.valorVencido91a180 = dto.getValorVencido91a180d();
            resume.valorVencido181a360 = dto.getValorVencido181a360d();
            resume.valorVencidoMas360 = dto.getValorVencidoMasde360d();
            resume.valorVencido181a270 = dto.getValorVencido181a270d();
            resume.valorVencidoMas270 = dto.getValorVencidoMasde270d();
            resume.valorVencido91a270 = dto.getValorVencido91a270d();
            resume.valorVencido271a360 = dto.getValorVencido271a360d();
            resume.valorVencido361a720 = dto.getValorVencido361a720d();
            resume.valorVencidoMas720 = dto.getValorVencidoMasde720d();
            resume.gastosRecuperacion = dto.getGastosRecuperaCarteraVencida();
            ...
            resume.valorInteresesCuota = dto.getValorInteresCuotaCredito();
            ...
            resume.fechaTransferenciaCuentasVencidas = dto.getFechaTransferCuentasVencidas();
            resume.interesesAcumuladosPorCobrar = dto.getInteresesAcumuladosCobrar();
            resume.interesesReversados = dto.getInteresesReservados();
